...
#+begin_src emacs-lisp
(setq user-full-name "katakam"
      user-mail-address "vinodk.katakam@gmail.com")
#+end_src
...
(use-package! calibredb
  :commands calibredb
  :config
  (setq calibredb-root-dir "~/Desktop/VK/Other/Ebooks"
...
(after! org-capture
  ...
  (defvar +org-capture-recipies  "~/Desktop/VK/Organisation/recipies.org")
...
#+begin_src emacs-lisp
(setq org-roam-directory "~/Desktop/VK/Organisation/Roam/")
#+end_src
...
#+begin_src emacs-lisp :noweb-ref none :tangle (if (file-exists-p "~/Desktop/VK/Organisation/Roam/") "no" "packages.el")
...
#+BEGIN_SRC emacs-lisp
(add-to-list 'exec-path "/Users/vkatakam/anaconda3/bin/python3")
(setq +python-ipython-repl-args '("-i" "--simple-prompt" "--no-color-info"))


(use-package conda
  :config
  (setq conda-anaconda-home (expand-file-name "/Users/vkatakam/anaconda3/"))
  (setq conda-env-home-directory (expand-file-name "/Users/vkatakam/anaconda3/"))
  (setq conda-env-subdirectory "envs"))
(setq python-shell-completion-native-enable . f)
...
(use-package jupyter
  ...
  (setq
       ...
       org-babel-python-command "/Users/vkatakam/anaconda3/bin/python3"
   ))
...
#+END_SRC
** Leetcode
*** Install my_cookies with pip install my_cookies
add extra headers to leetcode.el (host to leetcode)
...
(custom-set-variables '(package-selected-packages
                        '(ranger leetcode ejc-sql ))
                      )
(after! leetcode
(setq leetcode-prefer-language "python3"
      leetcode-prefer-sql "mysql"
      leetcode-save-solutions t
      leetcode-directory "/Users/vkatakam/learning/lc"
      )
)
#+END_SRC
***
